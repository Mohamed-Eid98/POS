                        ...
                        <form method="post">
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <div class="form-group">
                                    <div class="controls">
                                        <a href="{{ route('privacy.delivery.delete' , $privacy->id) }}"  class="btn btn-outline-danger waves-effect waves-light">حذف</a>
                                        <a href="{{ route('privacy.delivery.edit' , $privacy->id) }}"  class="btn btn-outline-primary waves-effect waves-light">تعديل</a>
                                        </div>
                                    </div>
                                </div>
