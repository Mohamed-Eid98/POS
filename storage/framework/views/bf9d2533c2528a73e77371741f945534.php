        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="index" key="t-default">إضافة قسم فرعي</a></li>
                        <li><a href="dashboard-saas" key="t-saas">عرض الاقسام الفرعيه</a></li>
                    </ul>
                </li>
...
<!-- Left Sidebar End -->
<?php /**PATH C:\xampp\htdocs\Dashboard-POS\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>