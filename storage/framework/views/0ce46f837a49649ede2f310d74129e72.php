            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item waves-effect" data-bs-toggle="dropdown"
                    ...
                    <?php switch(Session::get('lang')):
                        ...
                        <?php case ('it'): ?>
                            <img src="<?php echo e(URL::asset('/build/images/flags/italy.jpg')); ?>" alt="Header Language"
                                height="16">
                        <?php break; ?>
                        ...
                        <?php case ('es'): ?>
                            <img src="<?php echo e(URL::asset('/build/images/flags/spain.jpg')); ?>" alt="Header Language"
                                height="16">
                        <?php break; ?>
            ...
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <a class="dropdown-item" href="#"><i
                        ...
                        <span key="t-my-wallet"><?php echo app('translator')->get('translation.My_Wallet'); ?></span></a>
...
<?php /**PATH C:\Users\test\Desktop\New folder (2)\POS\resources\views/layouts/topbar.blade.php ENDPATH**/ ?>