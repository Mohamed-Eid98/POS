                    ...
                    <tbody>
                        ...
                        <?php $__currentLoopData = $subcategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subcategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr>
                                <td><?php echo e($i); ?></td>
                                <td>
                                    <?php if($subcategory->getFirstMediaUrl('images')): ?>
                                        <img src="<?php echo e($subcategory->getFirstMediaUrl('images')); ?>"
                                        style="width: 60px;height:50px" alt="<?php echo e($subcategory->title); ?>"
                                            class="img-fluid">
                                    <?php else: ?>
                                ...
                                <td>
                                    <a href="<?php echo e(route('subcategory.edit', $subcategory->id)); ?>" title="Edit Data"
                                        class="btn btn-sm btn-soft-primary"><i class="mdi mdi-pencil-outline"></i></a>
                                    <a href="<?php echo e(route('subcategory.delete', $subcategory->id)); ?>" title="حذف"
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\test\Downloads\New folder\POS\resources\views/sub_category/SubCategoryView.blade.php ENDPATH**/ ?>